...
Run on the reserved physical GPU XXX ::
    CUDA_VISIBLE_DEVICES=7 python scripts/train_cw.py --args.load conf/base_cw_audio.yml
    CUDA_VISIBLE_DEVICES=7 python scripts/train_cw.py --args.load conf/base_cw_eeg.yml
    #
    # To view output in tensorboard, run:
    tensorboard --logdir runs/eeg-dac_alice_cw_3/logs --port 6006 :: (see save_path in yml file)
"""
