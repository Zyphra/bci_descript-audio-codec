...
# (CW) - EEG losses moved into eegtools.data.datasets
if False:
    pass
...
# (CW) - EEG dataset setup moved into eegtools.data.datasets
if False:
    pass
...
# (CW) - EEG augmentation setup moved into eegtools.data.transforms
if False:
    pass
...
def train_loop(state: State, batch, lambdas: dict, scaler, amp: bool, grad_clip: float):
    ...
    # print(f"Inside train_eeg.py inside train_loop function")
    # import IPython; print('\n\nDebug:'); IPython.embed();  time.sleep(0.3)  
...
def train(
    ...
    # (CW) - turn WANDB plots of reconstructions, augmentations, codebook_usage off for now. Something breaks with n_codebooks!=2.
    plot_config["enabled"] = False 
    print(f"{plot_config['enabled']=}")
    ...
    for iteration in range(num_iters):
        ...
        # print(f"Inside train_eeg.py inside train function after {iteration=}")
        # import IPython; print('\n\nDebug:'); IPython.embed();  time.sleep(0.3)  
